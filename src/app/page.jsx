...
import {Navbar ,navLinks} from '@/components/layout/navbarLayout';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50">
     <Navbar/>
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-r from-teal-600 to-blue-600 relative overflow-hidden">
